...
/// PARSER
/// ===============================
List<NseStockModel> nseStockListFromJson(String str) =>
    List<NseStockModel>.from(
      json.decode(str).map((x) => NseStockModel.fromJson(x)),
    );
...
class NseStockModel {
  ...
  factory NseStockModel.fromJson(Map<String, dynamic> json) {
    return NseStockModel(
      ticker: json['ticker'],
